...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Título y subtítulo
\newcommand{\titulo}{Creación de un chatbot con IA capaz de buscar información en fuentes externas}
\newcommand{\subtitulo}{MMT Chat}
% Datos del autor
\newcommand{\miNombre}{Mario Martínez Turpín}
\newcommand{\miDNI}{49183039T}
\newcommand{\miEmail}{m.martinezturpin@um.es}
% Datos del tutor/es
\newcommand{\miTutor}{Jose Antonio Miñarro Gimenez}
\newcommand{\miTutorB}{Catalina Martínez Costa}
...
\newcommand{\logoDepartamento}{include/logos-titulaciones/Logotipo_DIS}
...
\begin{document}
	...
	\input{capitulos/6_evaluacion}
	\input{capitulos/7_conclusiones}
