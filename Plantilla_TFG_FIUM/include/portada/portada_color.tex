...
\begin{titlepage}
	...
	\vspace{1.5cm} % Un pelín más abajo
	\begin{center}
		\begin{spacing}{1.5}
			{\FuentePortada\fontsize{20pt}{40pt}\selectfont\color{\colortexto}\miGrado}
		\end{spacing}
	\end{center}
	\vspace{2cm}
	\vfill
	...
	\node[anchor=south west,inner sep=0pt] at ($(current page.south west)+(15cm,1.6cm)$)
