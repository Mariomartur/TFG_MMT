...
\begin{itemize}
    ...
    \item \textbf{Manejo Avanzado de Datos RDF:} Extraer, procesar y almacenar un conjunto significativo de datos provenientes de Wikidata en formato \textit{N-Triples} para conformar un Grafo de Conocimiento local optimizado, demostrando soltura en el manejo de tecnologías de la Web Semántica.
...
El \textbf{Capítulo 5} describe la Implementación del proyecto, profundizando en las decisiones de programación, el entorno tecnológico utilizado (Python, Ollama, Streamlit) y el despliegue del sistema mediante Docker.
